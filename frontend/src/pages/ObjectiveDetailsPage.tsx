...
import { ArrowLeft, Target, BarChart2, Plus, Pencil } from 'lucide-react';
...
export function ObjectiveDetailsPage() {
  ...
  const objective = useOKRStore((state) => 
  ...
  if (!objective) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="mt-2 text-sm font-medium text-gray-900">Objective not found</h3>
        <button
          onClick={() => navigate('/')}
  ...
  const handleUpdateKeyResult = (krId: string, updates: Partial<typeof objective.keyResults[0]>) => {
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="overflow-hidden h-2 text-xs flex rounded bg-gray-200">
                <div
                  ...
                  className={cn(
                    ...
                    objective.progress < 50 ? "bg-red-500" :
                    objective.progress < 80 ? "bg-yellow-500" : "bg-green-500"
                  )}
                />
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-5">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Key Results</h2>
            <div className="space-y-6">
              {objective.keyResults.map((kr) => (
                <div key={kr.id} className="border-b border-gray-200 last:border-0 pb-6 last:pb-0">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative">
                      <div className="overflow-hidden h-2 text-xs flex rounded bg-gray-200">
                        <div
                          ...
                          className={cn(
                            "shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center",
                            kr.progress < 50 ? "bg-red-500" :
                            kr.progress < 80 ? "bg-yellow-500" : "bg-green-500"
                          )}
                        />
                      </div>
                    </div>
      ...
      <ProgressModal
        ...
        currentProgress={objective.keyResults.find(kr => kr.id === selectedKR)?.progress || 0}
      ...
      <EditModal
        ...
        type={editModal.type === 'objective-description' ? 'textarea' : 'input'}
      />
